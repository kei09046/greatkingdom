...
public:
	...
	static pair<float, float> surprised(const pair<array<float, totSize + 1>, float> expected, 
	...
	void insert_equi_data(pair<float, float> policy_value_delta, std::array<float, 7 * largeSize>& _state,
