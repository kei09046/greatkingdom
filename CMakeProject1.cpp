...
int main() {
	//TrainPipeline* training_pipeline = new TrainPipeline("model3bv748400.pt", "model3bv748400.pt", /*gpu=*/true, 48400);
	...
	//TrainPipeline::play("model3bv748400.pt", false, 20000, 0.1f, true, true);

	ofstream totalResult("totalResult.txt");
	for (int i = 0; i < 4; ++i) {
		ofstream eachResult("res" + to_string(40000 + 2000 * (i + 1)) + ".txt");
		string file1 = "model3bv7" + to_string(40000 + 2000 * i) + string(".pt");
		string file2 = "model3bv7" + to_string(40000 + 2000 * (i + 1)) + string(".pt");
