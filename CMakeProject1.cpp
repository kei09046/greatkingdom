...
int main() {
	//TrainPipeline* training_pipeline = new TrainPipeline("model3bv823400.pt", "model3bv823400.pt", /*gpu=*/true, 23400);
	...
	TrainPipeline::play("model3bv823400.pt", false, 20000, 0.1f, true, true); // improved td
	// 
